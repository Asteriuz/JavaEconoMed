...
DROP TABLE HISTORICO_SAUDE_CLIENTE CASCADE CONSTRAINTS;

DROP TABLE HISTORICO_HOSPITAL_CLIENTE CASCADE CONSTRAINTS;
...
DROP TABLE ENDERECO_UNIDADE CASCADE CONSTRAINTS;

DROP TABLE MEDICO_UNIDADE CASCADE CONSTRAINTS;
...
CREATE TABLE HISTORICO_SAUDE_CLIENTE (
    ID NUMBER PRIMARY KEY,
    CLIENTE_ID NUMBER,
    DATA_REGISTRO DATE,
    FUMO VARCHAR(20),
...
CREATE TABLE HISTORICO_HOSPITAL_CLIENTE (
    ID NUMBER PRIMARY KEY,
    CLIENTE_ID NUMBER,
    DATA_REGISTRO DATE,
...
INSERT INTO CLIENTE (ID, RG, NOME, TELEFONE, EMAIL, DATA_NASCIMENTO, CPF, ESTADO_CIVIL, TEM_CONVENIO)
...
INSERT INTO ENDERECO_CLIENTE (ID, CLIENTE_ID, RUA, NUMERO, CIDADE, ESTADO, CEP)
...
INSERT INTO HISTORICO_SAUDE_CLIENTE (ID, CLIENTE_ID, DATA_REGISTRO, FUMO, DOENCA_PRINCIPAL, HISTORICO_FAMILIAR, ALERGIAS, OBSERVACOES)
...
INSERT INTO HISTORICO_HOSPITAL_CLIENTE (ID, CLIENTE_ID, DATA_REGISTRO, HISTORICO_MEDICO, EXAMES_REALIZADOS, MEDICAMENTOS_PRESCRITOS, OBSERVACOES)
...
INSERT INTO CONVENIO (ID, CLIENTE_ID, NOME, VALOR, TIPO_SERVICO, COBERTURA, CONTATO, VALIDADE)
...
INSERT INTO EMPRESA (ID, CNPJ, NOME, TIPO, TELEFONE, EMAIL, AREA_ATUACAO)
...
INSERT INTO ENDERECO_EMPRESA (ID, EMPRESA_ID, RUA, NUMERO, CIDADE, ESTADO, CEP)
...
INSERT INTO UNIDADE (ID, EMPRESA_ID, NOME, TELEFONE, EMAIL, TIPO, CAPACIDADE, ESPECIALIDADES)
...
INSERT INTO ENDERECO_UNIDADE (ID, UNIDADE_ID, RUA, NUMERO, CIDADE, ESTADO, CEP)
...
INSERT INTO MEDICO (ID, NOME, TELEFONE, EMAIL, ESPECIALIDADE, CRM)
...
INSERT INTO MEDICO_UNIDADE (ID, MEDICO_ID, UNIDADE_ID, HORARIO_ATENDIMENTO)
...
SELECT c.nome, co.nome FROM CLIENTE c JOIN CONVENIO co ON c.id = co.cliente_id;